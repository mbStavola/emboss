...
pub fn emboss_token(item: Embossable, options: EmbossingOptions) -> TokenStream2 {
    emboss_token_multiple(vec![item], options)
}

pub fn emboss_token_multiple(items: Vec<Embossable>, options: EmbossingOptions) -> TokenStream2 {
